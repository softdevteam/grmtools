...
fn test_grmtools_section_strings() {
    let srcs = [
        ...
        "%grmtools{test.x: y(z)}",
        "%grmtools{test.x: y(z),}",
        "%grmtools{test.a, test.x: y(z),}",
        "%grmtools{test.a, test.x: y(z)}",
        "%grmtools{test.a, !test.b, test.x: y(z), test.e: f}",
        "%grmtools{test.a, !test.b, test.x: y(z), test.e: f,}",
        "%grmtools{test.a, !test.b, test.x: w::y(z), test.e: f}",
        "%grmtools{test.a, !test.b, test.x: w::y(z), test.e: f,}",
        "%grmtools{test.a, !test.b, test.x: w::y(z), test.e: g::f}",
        "%grmtools{test.a, !test.b, test.x: w::y(z), test.e: g::f,}",
    ];
